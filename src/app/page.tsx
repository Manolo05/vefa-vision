...
/* ── SVG icons ── */
const IconArrow = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>svg>
  );
const IconArrowSm = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>svg>
  );
const IconSparkle = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>svg>
  );
const IconHome = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>svg>
  );
const IconFile = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>svg>
  );
const IconUsers = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>svg>
  );
const IconStack = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/></svg>svg>
  );
const IconBrain = () => (
...
const IconZap = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>svg>
  );
const IconShield = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>svg>
  );
const IconBar = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>svg>
  );
const IconClock = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>svg>
  );
const IconGlobe = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>svg>
  );
const IconCheck = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg>svg>
  );
const IconMenu = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>svg>
  );
const IconX = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>svg>
  );
          ...
          <>
                ...
                <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5">
                        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
                          ...
                          {/* Desktop */}
                                  <div className="hidden md:flex items-center gap-8">
                                              <a href="#features" className="text-sm text-zinc-400 hover:text-white transition-colors">Fonctionnalités</a>a>
                                              <a href="#pricing"  className="text-sm text-zinc-400 hover:text-white transition-colors">Tarifs</a>a>
                                              <a href="#modules"  className="text-sm text-zinc-400 hover:text-white transition-colors">Modules</a>a>
                                              <Link href="/dashboard" className="text-sm px-4 py-2 rounded-lg text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all font-medium">Connexion</Link>Link>
                  ...
                  {menuOpen && (
                      <div className="md:hidden border-t border-zinc-800 px-6 pb-6 pt-4 flex flex-col gap-4" style={{ background: "var(--card)" }}>
                                  <a href="#features" className="text-sm text-zinc-400" onClick={() => setMenuOpen(false)}>Fonctionnalités</a>a>
                                  <a href="#pricing"  className="text-sm text-zinc-400" onClick={() => setMenuOpen(false)}>Tarifs</a>a>
                                  <a href="#modules"  className="text-sm text-zinc-400" onClick={() => setMenuOpen(false)}>Modules</a>a>
                                  <Link href="/dashboard" className="text-sm text-zinc-400" onClick={() => setMenuOpen(false)}>Connexion</Link>Link>
                        ...
                        <div className="relative z-10 text-center max-w-4xl mx-auto px-6 space-y-8">
                          {/* Badge */}
                                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm text-zinc-400 border border-zinc-700" style={{ background: "var(--secondary)" }}>
                                              <span style={{ color: "var(--gold)" }}><IconSparkle /></span>span>
                          ...
                          {/* Headline */}
                                  <h1 className="font-bold leading-tight" style={{ fontSize: "clamp(2.4rem,6.5vw,4.75rem)", fontFamily: "'Space Grotesk',sans-serif" }}>
                                              ...
                                              <span className="grad-gold">commerciaux VEFA</span>span>
                                  </h1>h1>
            ...
            { val: "7 actions", lbl: "Outils PDF" },
                                        ...
                                        <div key={s.lbl} className="text-center">
                                                        <div className="text-2xl font-bold" style={{ color: "var(--gold)", fontFamily: "'Space Grotesk',sans-serif" }}>{s.val}</div>div>
                                                        <div className="text-sm text-zinc-500 mt-1">{s.lbl}</div>div>
                                        </div>div>
                                      ))}
                                  </div>div>
                        </div>div>
                        ...
                        <div className="max-w-6xl mx-auto px-6">
                                  <Anim className="text-center mb-16">
                                              <h2 className="font-bold mb-4" style={{ fontSize: "clamp(1.75rem,4vw,2.5rem)", fontFamily: "'Space Grotesk',sans-serif" }}>
                                                            4 modules, <span className="grad-gold">une seule plateforme</span>span>
                                              </h2>h2>
                                              <p className="text-zinc-400 max-w-xl mx-auto">Chaque module est conçu pour maximiser votre productivité et vos ventes VEFA.</p>p>
                                  </Anim>Anim>
                          ...
                          <Anim key={m.title} delay={i * 80}>
                                          <div className="rounded-xl p-6 border border-zinc-800 transition-all duration-300 hover:border-yellow-500/30 hover:shadow-gold group cursor-pointer" style={{ background: "var(--card)" }}>
                                                            <div className="flex gap-4 items-start">
                                                                                ...
                                                                                <div>
                                                                                                      <h3 className="font-semibold text-lg mb-2 text-white" style={{ fontFamily: "'Space Grotesk',sans-serif" }}>{m.title}</h3>h3>
                                                                                                      <p className="text-sm text-zinc-400 leading-relaxed">{m.desc}</p>p>
                                                                                                      <div className="flex flex-wrap gap-2 mt-4">
                                                                                                        {m.tags.map(t => <span key={t} className="tag">{t}</span>span>)}
                                                                                                        </div>div>
                                                                                  </div>div>
                                                            </div>div>
                                          </div>div>
            ...
            {/* ── FEATURES ── */}
                <section id="features" className="py-24" style={{ background: "hsl(225,20%,10%,.45)" }}>
                        <div className="max-w-6xl mx-auto px-6">
                                  <Anim className="text-center mb-16">
                                              <h2 className="font-bold mb-4" style={{ fontSize: "clamp(1.75rem,4vw,2.5rem)", fontFamily: "'Space Grotesk',sans-serif" }}>
                                                            Pourquoi choisir <span className="grad-gold">VEFA Vision</span>span> ?
                                              </h2>h2>
                                              <p className="text-zinc-400 max-w-xl mx-auto">Des outils pensés par et pour les professionnels de l&apos;immobilier neuf.</p>p>
                                  </Anim>Anim>
                          ...
                          <Anim key={f.title} delay={i * 70} className="text-center">
                                          ...
                                          <h3 className="font-semibold text-lg mb-2 text-white" style={{ fontFamily: "'Space Grotesk',sans-serif" }}>{f.title}</h3>h3>
                                          <p className="text-sm text-zinc-400 leading-relaxed">{f.desc}</p>p>
                          </Anim>Anim>
                        ))}
                                  </div>div>
                        </div>div>
            ...
            {/* ── PRICING ── */}
                <section id="pricing" className="py-24" style={{ background: "var(--bg)" }}>
                        <div className="max-w-6xl mx-auto px-6">
                                  <Anim className="text-center mb-16">
                                              <h2 className="font-bold mb-4" style={{ fontSize: "clamp(1.75rem,4vw,2.5rem)", fontFamily: "'Space Grotesk',sans-serif" }}>
                                                            Des tarifs <span className="grad-gold">transparents</span>span>
                                              </h2>h2>
                                              <p className="text-zinc-400 max-w-xl mx-auto">Choisissez le plan adapté à votre activité. Sans engagement.</p>p>
                                  </Anim>Anim>
                          ...
                          <Anim key={plan.name} delay={i * 100}>
                                          <div
                                            ...
                                            {plan.popular && (
                                                            ...
                                                            <div className="mb-6">
                                                                                <h3 className="font-bold text-xl text-white" style={{ fontFamily: "'Space Grotesk',sans-serif" }}>{plan.name}</h3>h3>
                                                                                <div className="flex items-baseline gap-1 mt-4 mb-2">
                                                                                                      <span className="text-4xl font-bold" style={{ fontFamily: "'Space Grotesk',sans-serif", color: plan.popular ? "var(--gold)" : "white" }}>
                                                                                                        {plan.price}
                                                                                                        </span>span>
                                                                                  {plan.period && <span className="text-zinc-400 text-sm">{plan.period}</span>span>}
                                                                                  {plan.price !== "Sur devis" && <span className="text-zinc-400 text-sm ml-1">€</span>span>}
                                                                                  </div>div>
                                                                                <p className="text-sm text-zinc-400">{plan.desc}</p>p>
                                                            </div>div>
                                          
                                                            <ul className="flex-1 flex flex-col gap-3 mb-8">
                                                              {plan.features.map(f => (
                                                                                    <li key={f} className="flex items-start gap-3 text-sm" style={{ color: "var(--secondary-fg)" }}>
                                                                                                            <span className="mt-0.5 flex-shrink-0" style={{ color: "var(--gold)" }}><IconCheck /></span>span>
                                                                                      {f}
                                                                                      </li>li>
                                                                                  ))}
                                                            </ul>ul>
                ...
                <footer className="border-t py-12" style={{ borderColor: "var(--border)", background: "hsl(225,20%,10%,.3)" }}>
                        <div className="max-w-7xl mx-auto px-6">
                                  <div className="flex flex-wrap items-center justify-between gap-6">
                                              <div>
                                                            <span className="font-bold text-xl grad-gold" style={{ fontFamily: "'Space Grotesk',sans-serif" }}>VEFA Vision</span>span>
                                                            <p className="text-sm text-zinc-500 mt-1">La suite IA pour l&apos;immobilier VEFA.</p>p>
                                              </div>div>
                                              <div className="flex items-center gap-6 flex-wrap">
                                                            <a href="#features" className="text-sm text-zinc-500 hover:text-white transition-colors">Fonctionnalités</a>a>
                                                            <a href="#pricing"  className="text-sm text-zinc-500 hover:text-white transition-colors">Tarifs</a>a>
                                                            <Link href="/dashboard" className="text-sm text-zinc-500 hover:text-white transition-colors">Connexion</Link>Link>
                                                            <Link href="/dashboard" className="text-sm text-zinc-500 hover:text-white transition-colors">Inscription</Link>Link>
                                              </div>div>
                                  </div>div>
