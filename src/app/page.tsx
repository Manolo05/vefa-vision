...
const MODULES = [
  ...
  },
  {
    ...
    features: ["OCR + Vision IA", "Brief commercial", "Fiche investisseur", "Contenu plaquette"],
  },
  {
    href: "/clients",
    icon: "👥",
    ...
    features: ["Pipeline Prospect→Signé", "8 templates email IA", "Checklist documents", "Suivi relances"],
  },
  {
    href: "/pdf-tools",
    icon: "📄",
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-6xl mx-auto px-4 py-10 sm:py-14">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#C9A96E]/10 border border-[#C9A96E]/30 text-[#C9A96E] text-sm font-medium mb-5">
            <span>✦</span>
            SaaS Immobilier VEFA — Powered by AI
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-3 tracking-tight">
            Bienvenue sur VEFA Vision
          </h1>
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
            La suite IA complète pour les commerciaux immobilier VEFA.
            Choisissez votre module ci-dessous.
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { label: "Vision & Analyse", value: "GPT-4o", icon: "🧠" },
